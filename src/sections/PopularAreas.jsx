...
const PopularAreas = () => {
    ...
    return (
        <div className={`${darkMode ? 'dark bg-blcak' : 'light bg-transparent'}`} >
            ...
            flex-col items-center lg:px-20 px-6 py-20 gap-20 `}  >
                <div id="top" className="w-full grid lg:gird-cols-3 grid-cols-1
                justify-center items-center gap-8">
                    ...
                    leading-10 mt-4 dark:text-white " >Explore most Popular Areas </h1>
                    </div>
                 ...
                 items-center gap-6">
                  ...
                  <div id="bottom" className="w-full grid lg:grid-cols-3 grid-cols1 
                  lg:justify-center lg:items-center gap-8 w-full"> 
