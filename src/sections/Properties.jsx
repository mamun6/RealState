...
import { FaBath, FaShareAlt, FaBed, FaUserCircle, FaPlus, FaMapMarkerAlt, FaViadeo, FaCamera, FaVideo, FaHeart } from "react-icons/fa"
...
const Properties = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`} >
      <section id="properties" className='lg:w-[90%] m-auto lg:px-20 px-6
         py-20 w-full flex flex-col justify-center items-start gap-10' >
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          <h1 data-aos="zoom-in" className="text-black text-[40px] font-semibold
                    leading-10 mt-4 dark:text-white ">Explore The latest</h1>
        </div>
        {/* properties gird starts from here */}

        <div id="gird-box" className="w-full grid lg:grid-cols-3 gird-cols-1
            ...
            property.map((item, index) => (
              <div data-aos="zoom-in" data-aos-delay="200" key={index}
                ...
                <div id="image-box" className="bg-cover bg-center h-[250px]
                  rounded-xl p-4 flex flex-col justify-between items-end" style={{
                    backgroundImage: `url(${item.images})`
                  }} >
                  <div id="top" className="flex justify-between items-end w-full" >
                    <div><button className="px-3 py-1 bg-red-600 hover:bg-white
                    hover:text-black text-white rounded-full text-[13px]" >Feature</button></div>
                    <div className="flex justify-between items-center gap-3" >
                      <button className="px-3 py-1 bg-red-600 hover:bg-white
                    hover:text-black text-white rounded-full text-[13px]" >Sales</button>
                      <button className="px-3 py-1 bg-red-600 hover:bg-white
                    hover:text-black text-white rounded-full text-[13px]" >Active</button>
                    </div>
                ...
                <div className="px-6 py-3 flex flex-col justify-center items-start gap-2 w-full">
                  ...
                  <div id="icons" className="flex justify-center items-start gap-4">
                    <div className="flex justify-center items-canter gap-2">
                  ...
                  <div id="owner-info" className="flex justify-between items-center
                    ...
                    <div className="flex justify-center items-center gap-4 ">
                      <div className="p-2 border-gray-200 hover:bg-black 
