  ...
  return (
    <div className={`${darkMode ? 'dark bg-blcak' : 'light bg-transparent'} pb-20` } >
      <section id='testimonials' className=' lg:w-[95%] w-full h-fit m-auto bg-cover
       bg-center rounded-xl flex flex-col justify-center items-start 
      lg:px-20 px-6 py-20 gap-20'>
        ...
        <h1 data-aos="zoom-in" className="text-black text-[40px] font-semibold leading-10
         dark:text-white" >What our clients <br /> saying about us</h1>
      </div>
      <div id='service-box' className="grid lg:grid-cols-3 grid-cols-1 justifyj-center
       itmes-center gap-8 w-full">
        {client.map((item,index)=>(
            <div data-aos="zoom-in" data-aos-delay="200" key={index} 
            className='bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer
             p-12 flex flex-col justify-center items-center gap-6 rounded-xl w-full'
            >
              <div  className="flex justify-start items-center w-full gap-4" >
                <img src={item.image} alt="" className='w-[70px] transform hover-scale-110 
