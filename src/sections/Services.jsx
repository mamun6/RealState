    ...
    <div className={`${darkMode ? 'dark bg-blcak' : 'light bg-transparent'} pb-20` } >
      ...
      <div className="flex flex-col justify-center items-start gap-4 ">
        ...
        <h1 data-aos="zoom-in" className="text-black text-[40px] font-semibold leading-10
         dark:text-white" >Top real estate <br /> servicess available</h1>
      </div>
       ...
       itmes-center gap-8">
        {service.map((item,index)=>(
          ...
          <div className="p-6 rounded-full bg-red-200 ">
            <item.icon className='text-red-600 size-10 transfrom 
          ...
          <h1 className='text-black text-[22px] font-semibold dark:text-white ' > 
            ...
            font-semibold-0 dark:text-white' >Read more..</button>
          </div>
        ))}
      </div>
       </section>
